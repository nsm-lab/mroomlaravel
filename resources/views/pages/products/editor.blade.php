    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            <form action="{{ route('products.update', $item->id) }}" method="POST">
                ...
                <div class="form-group">
                    <label for="price" class="form-control-label">Harga Kost</label>
                ...
                <div class="form-group">
                    <label for="quantity" class="form-control-label">Jumlah Kost Tersedia</label>
